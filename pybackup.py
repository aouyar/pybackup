...
class PgDumper():
    ...
    def pgDumpGlobals(self):
        ...
        try:
            ...
            raise BackupError("Failed creation of backup file.",
                             "Error Message: %s" % str(e))
        try:
            ...
            raise BackupError("Backup compression command failed.",
        ...
        if cmd1.returncode == 0 and cmd2.returncode == 0:
            ...
            raise BackupError("Dump failed with error code %s." 
                              % cmd1.returncode,
                              *errdata1.splitlines())
        elif cmd2.returncode != 0:
            raise BackupError("Compression of dump failed "
    ...
    def pgDumpDatabase(self, db):
        ...
        if cmd.returncode == 0:
            ...
            raise BackupError("Dump of database %s failed "
    ...
    def pgDumpDatabases(self):
        if self._conf['db_list'] is None:
            try:
                ...
                raise BackupError("Connection to PostgreSQL Server "
